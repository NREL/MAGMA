...
zone.gen = tryCatch( select(region_zone_gen(db), Region, Zone, Type, GWh = value), error = function(cond) { return('ERROR') } )
...
if ( typeof(zone.gen)=='character' ) {
  ...
  # py=pretty(zone.gen.sum$TWh, n=5, min.n = 5)
