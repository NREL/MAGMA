...
```{r key-period-line-flow-scen-{{period.name}}, results='asis', include=TRUE}
...
```{r key-period-line-flow-scen-plots-{{period.name}}, fig.width=figure.width, fig.height=figure.height, include=TRUE}
