...
```{r daily_curtailment, include=TRUE}

if ( exists('dy.curt') ) {

if ( typeof(dy.curt)=='character' ) { 
  print('ERROR: daily_curtailment function in "yearly-curtailment" chunk not returning correct results.')
} else {
...
} else { print('Curtailment data not found. Make sure "yearly-curtailment" chunk is running.') }
```
