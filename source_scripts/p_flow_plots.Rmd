***
```{r Period-flow-{{period.name}}, results='asis', echo=FALSE}
cat("#### {{period.name}}")
text.plot=11
figure.width = 9
figure.height = 4
...
ggplot(filter(zonal.flows, zonal.flows$Period == '{{period.name}}'), aes(x=time, y=-value/1000, color=name, group=name))+
      geom_line(size=1.3)+
