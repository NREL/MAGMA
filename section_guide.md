...
4. **Individual Region Generation Stacks**
 ...
 + Generator - generation, available energy
 + Region - load
5. **Specific Period Time Series Dispatch Plots**
6. **Specific Period Time Series Dispatch Plots**
7. **Specific Period Time Series Dispatch Plots**
 + **Interval:**
...
8. **Curtailment Plots**
9. **Curtailment Plots**
10. **Curtailment Plots**
11. **Curtailment Plots**
 + **Interval:**
 + Generator - generation, available capacity, units generating
12. **Total Generation Table**
 + **Total:**
...
29. **Reserves Price Duration Curves**
 + **Interval:**
 + Reserves - price
30. **Day Ahead to Real Time Committment and Dispatch Plots**
31. **Day Ahead to Real Time Committment and Dispatch Plots**
 + **Interval:**
 + Generator - generation, available capacity, units generating
 + Region - load, unserved energy
 + Zone - load, unserved energy
