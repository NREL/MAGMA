...
if (exists('region.names')) { r.height = ( length(region.names[!region.names%in%ignore.regions]) %/% 3 + 
                                             length(region.names[!region.names%in%ignore.regions]) %% 3 ) * 5
  } else {r.height = 5 }
...
if (zone.gen.stacks) {
  if ( typeof(total.generation)=='character' ) {
    ...
    print(plot.data[[1]] + facet_wrap(~Zone, scales = 'free', ncol=3)+
      theme(aspect.ratio = 2.5, axis.text.x = element_text(angle = -30, hjust = 0)))
  }
} else { print('Section not run according to input file.') }
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
```
...
```{r region-gen-stacks, resize.height=T, fig.height=r.height, fig.width=12}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if ( typeof(total.generation)=='character' ) {
    ...
    if ( typeof(r.z.gen)=='character' ) {
      ...
      p1 <- gen_stack_plot(r.z.gen[(!Zone %in% ignore.zones & !Region %in% ignore.regions),],
                           ...
                           filters = c('Region'))
      print(p1[[1]] + facet_wrap(~Region, scales = 'free', ncol=3) + 
        theme(aspect.ratio = 2.5, axis.text.x = element_text(angle = -30, hjust = 0)))
    }
  }
} else { print('Section not run according to input file.') }
...
source("source_scripts/compare/c_d_curtailment_data.R")
```
***
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
source('source_scripts/compare/c_d_interface_data.R')
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
```
***
## 17. Average Interval Interface Flow
```{r interface-interval-flow-plots, resize.width=T, fig.width=10, fig.height=i.height}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
```{r interface-daily-flow-plots, resize.width=T, fig.width=10, fig.height=i.height}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
```{r interface-interval-diff-flow-plots, resize.width=T, fig.width=10, fig.height=i.height}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
```{r interface-daily-diff-flow-plots, resize.width=T, fig.width=10, fig.height=i.height}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
source('source_scripts/compare/c_d_line_data.R')
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
```
***
## 20. Average Interval Line Flow
```{r line-interval-flow-plots, resize.width=T, fig.width=10, fig.height=l.height}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
print(p.int.line)
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
```
...
```{r line-daily-flow-plots, resize.width=T, fig.width=10, fig.height=l.height}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
print(p.daily.line)
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
```
...
```{r line-interval-diff-flow-plots, resize.width=T, fig.width=10, fig.height=l.height}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
```{r line-daily-diff-flow-plots, resize.width=T, fig.width=10, fig.height=l.height}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if (length(period.names)>0) {
      ...
      if ( exists('plot.flows') ) {
        ...
        if ( typeof(plot.flows)=='character' ) {
          ...
          key.plots = lapply(period.names, function(p){
            knit_expand(file = 'source_scripts/compare/c_p_key_period_line_flow.Rmd', period.name = p)
          }) 
          # Reconstruct the plot data into a format that will be output into the HTML below
...
## 22-25. Reserves
***
### 22. Annual Reserve Provision by Scenario (GW)
...
***
### 22.1 Annual Reserve Provision Difference by Scenario (GW)
...
if(annual.reserves.table) {
  if (typeof(total.reserve.provision)=='character' | typeof(total.reserve.shortage)=='character'){
    ...
    # Call the query function to get annual reserve amounts.
    annual.reserves.diff = tryCatch( annual_reserves_diff(), 
                                error = function(cond) { return('ERROR: annual_reserves function not returning correct results.') })
...
***
### 23. Annual Reserve Shortage by Scenario (GW)
...
if (annual.res.short.table) {
  ...
  res.short.table = dcast.data.table(res.short.table,Type~scenario,value.var="Shortage (GWh)")
...
***
### 23.1 Annual Reserve Shortage Difference by Scenario (GW)
  ...
  if (typeof(total.gen.res)=='character'){
    ...
    if ( typeof(yr.res.scen)=='character' ) { 
      ...
      print(plot.data[[1]] + facet_wrap(~Reserve,ncol=3,scales='free') + 
              theme(aspect.ratio = 2.5/length(db.loc),axis.text.x = element_text(angle = -30, hjust = 0)))
    }
  }
} else { print('Section not run according to input file.') }
...
```{r reserves-stacks-diff, fig.height=res.height, fig.width=10}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Check if this section was selected to run in the input file
if(reserve.stack) {
  if (typeof(total.gen.res)=='character'){
