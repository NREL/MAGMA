...
```{r region-gen-stacks, resize.height=T, fig.height=s.height, fig.width=10}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  if (length(interfaces)>0) {
    if ( typeof(interval.interface.flow) == 'character' ) {
      ...
      if ( typeof(interface.flows)=='character' ) { 
        ...
        # Get interval plots
        p1 = interface_plot(interface.flows, x_col = 'time', color='scenario')
...
if(reserves.plots) {
  if (typeof(interval.reserve.provision)=='character'){
    ...
    if ( typeof(r)=='character' ) { 
      ...
      p.1 = line_plot(int.avg, 'interval','time', 'Provision', 'Reserve Provision (GWh)',color='scenario')
      ...
      p.2 = line_plot(dy.avg, 'day','time', 'Provision', 'Reserve Provision (GWh)',color='scenario')
      if (nrow(dy.avg) > 30) {
