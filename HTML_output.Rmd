...
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if (key.period.dispatch.total | key.period.dispatch.zone | key.period.dispatch.region){  
...
if ( typeof(key.period.gen)=='character' ) {
  ...
  # Reconstruct the plot data into a format that will be output into the HTML below
  if (key.period.dispatch.total) { key.period.dispatch.total = knit_child(text = unlist(key.plots.total)) }
  if (key.period.dispatch.zone) { key.period.dispatch.zone = knit_child(text = unlist(key.plots.zone)) }
  if (key.period.dispatch.region) { key.period.dispatch.region = knit_child(text = unlist(key.plots.region)) }
}
} else { key.period.dispatch.total  = 'Section not run according to input file.'
...
```{r committment-dispatch}
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
source('source_scripts/p_DA_RT_commit_dispatch.R')
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
```
